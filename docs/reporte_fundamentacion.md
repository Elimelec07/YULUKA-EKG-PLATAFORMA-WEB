...
❤️ Detección Automatizada como Soporte (Pan-Tompkins)
...
⚠️ Nota Legal: Yuluka‑EKG no es un dispositivo médico certificado (SaMD). Su uso es estrictamente educativo y formativo para la simulación de escenarios de cuidado crítico.
